<div>@extends('admin.include.layout')
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            $check =check_permission('insert_category');

                            ?>
                            @if($check == 0) 
                            <Button disabled  class="btn btn-success" name="insert_category" data-toggle="modal" data-target="#myModal" title ="you don't have permission to do this action!!"><i class="fa fa-plus-circle"></i> Add</Button>
                            @else
                            <Button class="btn btn-success" name="insert_category" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus-circle"></i> Add</Button>
                            @endif
                        </div>
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" style="position: absolute;transform: translate3d(0px, 38px, 0px);top: 35px;left: 0px;will-change: transform;">
                                ...
                                @else
                                <a class="dropdown-item  badge badge-primary" href="{{ route('admin.categories.edit',$c->id) }}"><i class="fa fa-edit"></i> Edit</a><br>
                                @endif
...
<script type="text/javascript">
    ...
    $('input[name=name_search').on('keyup',function(){
        ...
        // $('button[name=insert_category]').on('click',function(){

        //     check = $('input[name=check]').val();
        //     if(check == 0) {
        //         alert("You don't have permission to do that action");
