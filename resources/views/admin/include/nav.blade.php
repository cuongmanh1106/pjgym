                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-id-badge"></i><a href="{{ route('admin.categories.insert') }}" data-toggle="modal" >Insert</a></li>
                    ...
                    <li class="menu-item-has-children active dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="{{ route('admin.products.list') }}">List of products</a></li>
                            <li><i class="fa fa-table"></i><a href="{{ route('admin.products.create') }}">Insert a product</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-th"></i><a href="{{ route('admin.users.create') }}">Insert</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href="{{ route('admin.permission.list') }}">List</a></li>
