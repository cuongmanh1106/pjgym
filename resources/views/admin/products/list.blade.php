            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.products.create') }}" class="btn btn-success"><i class="fa fa-plus-circle"></i> Add</a>
                    </div>
                  ...
                  <tr id="row_pro_{{$p->id}}">
                     ...
                     <td>
                       ...
                       <div class="dropdown-menu" style="position: absolute;transform: translate3d(0px, 38px, 0px);top: 35px;left: 0px;will-change: transform;">
                        ...
                        <button disabled class="dropdown-item badge badge-danger"  ><i class="fa fa-trash-o"></i> Xóa</button>
                        @else 
